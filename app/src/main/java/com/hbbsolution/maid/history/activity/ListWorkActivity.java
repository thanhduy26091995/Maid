...
public class ListWorkActivity extends BaseActivity implements ListWorkView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            idOwner = extras.getString("idOwner");
            mListWorkPresenter.getInfoListWorkHistory(idOwner, currentPage);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                if (currentPage < pages) {
                    mListWorkPresenter.getMoreInfoListWorkHistory(idOwner, currentPage + 1);
                }
            }
        };
